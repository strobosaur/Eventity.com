<?php
    ...
    if(!isset($_POST["create"]) || !isset($_SESSION["userID"])) {
        ...
        $sql = "INSERT INTO events (event_userID, event_name, event_text, event_adress, event_zip, event_city, event_lat, event_lng, event_date, event_enddate, event_time, event_endtime, event_price)
                VALUES (:event_userID, :event_name, :event_text, :event_adress, :event_zip, :event_city, :event_lat, :event_lng, :event_date, :event_enddate, :event_time, :event_endtime, :event_price)";
